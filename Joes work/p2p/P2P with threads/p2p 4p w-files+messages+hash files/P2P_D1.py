...
filepath = 'C:\\Users\\jsmul\\Desktop\\College Year 3\\Semester 2\\3D3 Computer Networks\\Project 2\\project 2 repo\\Joes work\\p2p\\P2P with threads\\p2p 4 peers with files\\DataBase_D\\DATABASE.txt'
...
def send_message(ip, udp_d_port):
            ...
            time.sleep(0.1)
            marker = 't'
            send_sock.sendto(marker.encode(), (ip, udp_d_port))
            send_sock.close()
